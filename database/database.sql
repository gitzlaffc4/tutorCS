...
CREATE TABLE USER_T(
	...
	STUDENT VARCHAR(1) NOT NULL DEFAULT 0,
	TUTOR VARCHAR(1) NULL DEFAULT 0,
	PROFESSOR VARCHAR(1) NOT NULL DEFAULT 0,
...
CREATE TABLE ENROLLED_T(
	...
	ALLOC_SESSIONS INT(2) NOT NULL DEFAULT 6,
...
-- BR: A SESSION END TIME MUST BE 30 MINUTES AFTER START
...
CREATE TABLE SCHEDULED_T(
	...
	CANC_BY_TUT VARCHAR(1) NOT NULL DEFAULT '0',
	CANC_BY_STUD VARCHAR(1) NOT NULL DEFAULT '0',
	COMMENTS TEXT,
PRIMARY KEY (SESSION_ID),
