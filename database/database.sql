...
CREATE TABLE USER_T(
	...
	TUTOR VARCHAR(5) NULL,
	PROFESSOR VARCHAR(5) NOT NULL,
	ADMIN VARCHAR(5) NOT NULL,
	NICK_NAME VARCHAR(255),
	PHONE_NUMBER VARCHAR(10),
	PICTURE VARCHAR(255),
PRIMARY KEY (HAWKID) ON DELETE CASCADE,
FOREIGN KEY (HAWKID) REFERENCES ACCOUNT_T(HAWKID) ON DELETE CASCADE);
...
PRIMARY KEY (HAWKID),
FOREIGN KEY (HAWKID) REFERENCES USER_T(HAWKID) ON DELETE CASCADE ON UPDATE CASCADE);
...
FOREIGN KEY (HAWKID) REFERENCES STUDENT_T(HAWKID) ON DELETE CASCADE ON UPDATE CASCADE,
FOREIGN KEY (COURSE_ID) REFERENCES COURSE_T(COURSE_ID) ON DELETE CASCADE ON UPDATE CASCADE);
...
CREATE TABLE TUTORS_T(
	...
	COURSE_ID INT(8) NOT NULL,
PRIMARY KEY (HAWKID, COURSE_ID),
FOREIGN KEY (HAWKID) REFERENCES TUTOR_T(HAWKID) ON DELETE CASCADE ON UPDATE CASCADE,
FOREIGN KEY (COURSE_ID) REFERENCES COURSE_T(COURSE_ID) ON DELETE CASCADE ON UPDATE CASCADE);
...
CREATE TABLE AVAILABILITY_T(
	AVAILSLOTID INT(10) NOT NULL AUTO_INCREMENT,
	HAWKID VARCHAR(255) NOT NULL,
	DAY_OF_WEEK VARCHAR(10) NOT NULL,
	AVAILABLE VARCHAR(1) NOT NULL,
	TIME_START TIME,
	TIME_STOP TIME,
PRIMARY KEY (AVAILSLOTID),
FOREIGN KEY (HAWKID) REFERENCES TUTOR_T(HAWKID) ON DELETE CASCADE ON UPDATE CASCADE);
...
FOREIGN KEY (TUTOR_HAWKID) REFERENCES TUTOR_T(HAWKID) ON DELETE CASCADE ON UPDATE CASCADE,
FOREIGN KEY (COURSE_ID) REFERENCES COURSE_T(COURSE_ID) ON DELETE CASCADE ON UPDATE CASCADE);
...
CREATE TABLE SCHEDULED_T(
	...
	CANC_BY_TUT VARCHAR(1) NOT NULL,
	CANC_BY_STUD VARCHAR(1) NOT NULL,
	COMMENTS TEXT,
PRIMARY KEY (SESSION_ID),
FOREIGN KEY (SESSION_ID) REFERENCES SESSION_T(SESSION_ID) ON DELETE CASCADE ON UPDATE CASCADE,
FOREIGN KEY (STUD_HAWKID) REFERENCES STUDENT_T(HAWKID) ON DELETE CASCADE ON UPDATE CASCADE,
FOREIGN KEY (MATERIAL_ID) REFERENCES MATERIALS_T(MATERIAL_ID) ON DELETE CASCADE ON UPDATE CASCADE);