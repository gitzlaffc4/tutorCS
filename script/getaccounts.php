...
$tutorQuery = "SELECT USER_T.*, TUTOR_T.HAWKID, TUTOR_T.BIO, TUTORS_T.COURSE_ID, COURSE_T.COURSE_NAME, (SELECT COUNT(SESSION_ID) FROM SESSION_T, TUTOR_T WHERE TUTOR_T.HAWKID = SESSION_T.TUTOR_HAWKID)


FROM USER_T, TUTOR_T, TUTORS_T, COURSE_T, SESSION_T, SCHEDULED_T 
WHERE TUTOR_T.HAWKID = USER_T.HAWKID AND TUTOR_T.HAWKID = SESSION_T.TUTOR_HAWKID AND SCHEDULED_T.SESSION_ID = SESSION_T.SESSION_ID AND TUTOR_T.HAWKID = TUTORS_T.HAWKID AND TUTORS_T.COURSE_ID = COURSE_T.COURSE_ID;";
